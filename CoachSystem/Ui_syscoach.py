...
"")
        ...
        self.btn_confirm_2.setGeometry(QtCore.QRect(20, 300, 201, 61))
        self.btn_confirm_2.setObjectName("btn_confirm_2")
        self.btn_remove = QtWidgets.QPushButton(self.groupBox_4)
        self.btn_remove.setGeometry(QtCore.QRect(20, 390, 201, 61))
        ...
        self.btn_verify = QtWidgets.QPushButton(self.groupBox_4)
        self.btn_verify.setGeometry(QtCore.QRect(230, 300, 101, 151))
        ...
        self.lb_status = QtWidgets.QLabel(self.page_2)
        self.lb_status.setGeometry(QtCore.QRect(890, 540, 121, 16))
    ...
    def retranslateUi(self, sysCoach):
        ...
        self.btn_verify.setText(_translate("sysCoach", "认证"))
        ...
        self.lb_status.setText(_translate("sysCoach", "当前状态：未认证"))
