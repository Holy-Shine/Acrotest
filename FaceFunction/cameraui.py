...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.showinfo.setText(_translate("Form", "l"))
        self.showname.setText(_translate("Form", "l"))
        self.showsex.setText(_translate("Form", "l"))
        self.showage.setText(_translate("Form", "l"))
