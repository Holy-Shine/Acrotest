...
"")
        ...
        item = QtWidgets.QListWidgetItem()
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("resource/goods_price.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon3)
        self.listFunc.addItem(item)
        item = QtWidgets.QListWidgetItem()
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("resource/goods_fluid.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon4)
        self.listFunc.addItem(item)
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(20, 30, 411, 23))
        ...
        self.cb_fluid_year = QtWidgets.QComboBox(self.layoutWidget3)
        ...
        self.gb_inout = QtWidgets.QGroupBox(self.page_4)
        self.gb_inout.setGeometry(QtCore.QRect(31, 130, 391, 391))
        self.gb_inout.setObjectName("gb_inout")
        self.groupBox_8 = QtWidgets.QGroupBox(self.page_4)
        self.groupBox_8.setGeometry(QtCore.QRect(441, 40, 601, 81))
        self.groupBox_8.setObjectName("groupBox_8")
        self.layoutWidget_2 = QtWidgets.QWidget(self.groupBox_8)
        self.layoutWidget_2.setGeometry(QtCore.QRect(18, 30, 571, 30))
        self.layoutWidget_2.setObjectName("layoutWidget_2")
        self.gridLayout_9 = QtWidgets.QGridLayout(self.layoutWidget_2)
        self.gridLayout_9.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.cb_show_num_month_2 = QtWidgets.QComboBox(self.layoutWidget_2)
        self.cb_show_num_month_2.setObjectName("cb_show_num_month_2")
        self.cb_show_num_month_2.addItem("")
        self.cb_show_num_month_2.addItem("")
        self.cb_show_num_month_2.addItem("")
        self.cb_show_num_month_2.addItem("")
        self.gridLayout_9.addWidget(self.cb_show_num_month_2, 0, 0, 1, 1)
        self.btn_show_inoutLine = QtWidgets.QPushButton(self.layoutWidget_2)
        self.btn_show_inoutLine.setObjectName("btn_show_inoutLine")
        self.gridLayout_9.addWidget(self.btn_show_inoutLine, 0, 1, 1, 1)
        self.gridLayout_9.setColumnStretch(0, 1)
        self.gb_inouthis = QtWidgets.QGroupBox(self.page_4)
        self.gb_inouthis.setGeometry(QtCore.QRect(440, 130, 601, 391))
        self.gb_inouthis.setObjectName("gb_inouthis")
        self.groupBox_4 = QtWidgets.QGroupBox(self.page_4)
        self.groupBox_4.setGeometry(QtCore.QRect(31, 40, 391, 81))
        self.groupBox_4.setObjectName("groupBox_4")
        self.layoutWidget_3 = QtWidgets.QWidget(self.groupBox_4)
        self.layoutWidget_3.setGeometry(QtCore.QRect(10, 20, 371, 51))
        ...
        self.cb_bar_inout_month = QtWidgets.QComboBox(self.layoutWidget_3)
        self.cb_bar_inout_month.setObjectName("cb_bar_inout_month")
        self.cb_bar_inout_month.addItem("")
        self.cb_bar_inout_month.addItem("")
        self.cb_bar_inout_month.addItem("")
        self.cb_bar_inout_month.addItem("")
        self.cb_bar_inout_month.addItem("")
        ...
        self.cb_bar_inout_month.addItem("")
        self.cb_bar_inout_month.addItem("")
        self.gridLayout_4.addWidget(self.cb_bar_inout_month, 0, 3, 1, 1)
        self.cb_bar_inout_year = QtWidgets.QComboBox(self.layoutWidget_3)
        self.cb_bar_inout_year.setObjectName("cb_bar_inout_year")
        self.cb_bar_inout_year.addItem("")
        self.cb_bar_inout_year.addItem("")
        self.cb_bar_inout_year.addItem("")
        self.gridLayout_4.addWidget(self.cb_bar_inout_year, 0, 1, 1, 1)
        ...
        self.btn_show_inout_bar = QtWidgets.QPushButton(self.layoutWidget_3)
        self.btn_show_inout_bar.setObjectName("btn_show_inout_bar")
        self.gridLayout_4.addWidget(self.btn_show_inout_bar, 0, 6, 2, 1)
        self.cb_inout_goods = QtWidgets.QComboBox(self.layoutWidget_3)
        self.cb_inout_goods.setObjectName("cb_inout_goods")
        self.gridLayout_4.addWidget(self.cb_inout_goods, 1, 1, 1, 3)
        ...
        self.label_10.setStyleSheet("font: 75 14pt \"黑体\";")
        self.label_10.setObjectName("label_10")
        self.stackedWidget.addWidget(self.page_4)
        self.page_5 = QtWidgets.QWidget()
        self.page_5.setObjectName("page_5")
        self.groupBox_5 = QtWidgets.QGroupBox(self.page_5)
        self.groupBox_5.setGeometry(QtCore.QRect(55, 40, 451, 80))
        self.groupBox_5.setObjectName("groupBox_5")
        self.layoutWidget_4 = QtWidgets.QWidget(self.groupBox_5)
        self.layoutWidget_4.setGeometry(QtCore.QRect(20, 30, 430, 23))
        ...
        self.cb_fluid_year_2 = QtWidgets.QComboBox(self.layoutWidget_4)
        self.cb_fluid_year_2.setObjectName("cb_fluid_year_2")
        self.gridLayout_5.addWidget(self.cb_fluid_year_2, 0, 1, 1, 1)
        ...
        self.cb_fluid_inout.setObjectName("cb_fluid_inout")
        self.gridLayout_5.addWidget(self.cb_fluid_inout, 0, 5, 1, 1)
        ...
        self.groupBox_9.setGeometry(QtCore.QRect(525, 40, 481, 80))
        self.groupBox_9.setObjectName("groupBox_9")
        self.layoutWidget_5 = QtWidgets.QWidget(self.groupBox_9)
        self.layoutWidget_5.setGeometry(QtCore.QRect(40, 17, 411, 51))
        self.layoutWidget_5.setObjectName("layoutWidget_5")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.layoutWidget_5)
        self.gridLayout_6.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.btn_fluid_excrt_2 = QtWidgets.QPushButton(self.layoutWidget_5)
        self.btn_fluid_excrt_2.setObjectName("btn_fluid_excrt_2")
        self.gridLayout_6.addWidget(self.btn_fluid_excrt_2, 0, 1, 1, 1)
        self.btn_fluid_expall_2 = QtWidgets.QPushButton(self.layoutWidget_5)
        self.btn_fluid_expall_2.setObjectName("btn_fluid_expall_2")
        self.gridLayout_6.addWidget(self.btn_fluid_expall_2, 0, 2, 1, 1)
        self.btn_fluid_getDB_2 = QtWidgets.QPushButton(self.layoutWidget_5)
        self.btn_fluid_getDB_2.setObjectName("btn_fluid_getDB_2")
        self.gridLayout_6.addWidget(self.btn_fluid_getDB_2, 0, 0, 1, 1)
        self.tv_fluid_2 = QtWidgets.QTableView(self.page_5)
        self.tv_fluid_2.setGeometry(QtCore.QRect(50, 131, 961, 381))
        self.tv_fluid_2.setObjectName("tv_fluid_2")
        self.label_15 = QtWidgets.QLabel(self.page_5)
        self.label_15.setGeometry(QtCore.QRect(10, 0, 141, 31))
        self.label_15.setStyleSheet("font: 75 14pt \"黑体\";")
    ...
    def retranslateUi(self, sumSys):
        ...
        item = self.listFunc.item(3)
        item.setText(_translate("sumSys", "入库出库统计"))
        item = self.listFunc.item(4)
        item.setText(_translate("sumSys", "入库出库流水"))
        ...
        self.gb_inout.setTitle(_translate("sumSys", "某月的入库出库数据"))
        self.groupBox_8.setTitle(_translate("sumSys", "选择显示多少个月"))
        self.cb_show_num_month_2.setItemText(0, _translate("sumSys", "3个月"))
        self.cb_show_num_month_2.setItemText(1, _translate("sumSys", "6个月"))
        self.cb_show_num_month_2.setItemText(2, _translate("sumSys", "9个月"))
        self.cb_show_num_month_2.setItemText(3, _translate("sumSys", "12个月"))
        self.btn_show_inoutLine.setText(_translate("sumSys", "展示"))
        self.gb_inouthis.setTitle(_translate("sumSys", "近几个月的入库出库以及利润统计"))
        self.groupBox_4.setTitle(_translate("sumSys", "选择展示的年月"))
        self.label_9.setText(_translate("sumSys", "月："))
        self.cb_bar_inout_month.setItemText(0, _translate("sumSys", "1"))
        self.cb_bar_inout_month.setItemText(1, _translate("sumSys", "2"))
        self.cb_bar_inout_month.setItemText(2, _translate("sumSys", "3"))
        self.cb_bar_inout_month.setItemText(3, _translate("sumSys", "4"))
        self.cb_bar_inout_month.setItemText(4, _translate("sumSys", "5"))
        self.cb_bar_inout_month.setItemText(5, _translate("sumSys", "6"))
        self.cb_bar_inout_month.setItemText(6, _translate("sumSys", "7"))
        self.cb_bar_inout_month.setItemText(7, _translate("sumSys", "8"))
        self.cb_bar_inout_month.setItemText(8, _translate("sumSys", "9"))
        self.cb_bar_inout_month.setItemText(9, _translate("sumSys", "10"))
        self.cb_bar_inout_month.setItemText(10, _translate("sumSys", "11"))
        self.cb_bar_inout_month.setItemText(11, _translate("sumSys", "12"))
        self.cb_bar_inout_year.setItemText(0, _translate("sumSys", "2019"))
        self.cb_bar_inout_year.setItemText(1, _translate("sumSys", "2020"))
        self.cb_bar_inout_year.setItemText(2, _translate("sumSys", "2021"))
        self.label_8.setText(_translate("sumSys", "年："))
        self.label_11.setText(_translate("sumSys", "货物："))
        self.btn_show_inout_bar.setText(_translate("sumSys", "展示"))
        self.label_10.setText(_translate("sumSys", "入库出库统计"))
        self.groupBox_5.setTitle(_translate("sumSys", "选择栏(默认可选近3年的流水)"))
        self.label_12.setText(_translate("sumSys", "年："))
        self.label_16.setText(_translate("sumSys", "出/入库："))
        self.label_14.setText(_translate("sumSys", "月："))
        self.groupBox_9.setTitle(_translate("sumSys", "操作栏"))
        self.btn_fluid_excrt_2.setText(_translate("sumSys", "导出当前流水"))
        self.btn_fluid_expall_2.setText(_translate("sumSys", "导出全部流水"))
        self.btn_fluid_getDB_2.setText(_translate("sumSys", "获取数据库流水信息"))
        self.label_15.setText(_translate("sumSys", "入库出库流水"))
