...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pb_main_QuerySystem = QtWidgets.QPushButton(self.fr_main_menu)
        self.pb_main_QuerySystem.setGeometry(QtCore.QRect(880, 10, 181, 111))
        self.pb_main_QuerySystem.setObjectName("pb_main_QuerySystem")
        ...
        self.lb_main_test = QtWidgets.QLabel(self.fr_main_show)
        self.lb_main_test.setGeometry(QtCore.QRect(490, 240, 301, 81))
        self.lb_main_test.setObjectName("lb_main_test")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "FreeStyle轮滑体验馆管理系统"))
        ...
        self.pb_main_QuerySystem.setText(_translate("MainWindow", "查询系统"))
        self.pb_main_StatisticSystem.setText(_translate("MainWindow", "统计系统"))
        self.lb_main_test.setText(_translate("MainWindow", "测试嵌入样本"))
